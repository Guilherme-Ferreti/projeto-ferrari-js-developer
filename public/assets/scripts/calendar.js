import { endOfMonth, endOfWeek, format, startOfWeek, startOfMonth, differenceInSeconds, addDays, addMonths, subMonths } from 'date-fns';
...
document.querySelectorAll('#schedules-new').forEach(page => {
    ...
    // input.addEventListener('change', e => button.disabled = !e.target.value);
